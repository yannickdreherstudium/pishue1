...
public class WuerfelTest {
	...
	public void testKodiereWuerfel() {
		assertEquals("rza  me rhoeTiu r yn1471?a gikptvwrsna edcBe,2580Fnjtmoltealt xqruhar 369!",
				codec_1.kodiere("Franz jagt im komplett verwahrlosten Taxi quer durch Bayern, 12345678910!?"));
		assertEquals(" ridtr ntelao7r5a3eypBohziaaF !m kcmurT?n0t9e1s8l6r1v,trh4w2e au  nx  gejq",
		...
		assertEquals("rneregnfirsrtdeulnsptnveoedtmeeregteaefntnfuei",
				codec_1.kodiere("eintreffendersendungverspaetetneuerterminfolgt"));
		assertEquals("ndeeelmtsvtrngieedffprugnennsefiteereertoarutn",
	...
	public void testDekodiereWuerfel() {
		...
		assertEquals("eintreffendersendungverspaetetneuerterminfolgt",
